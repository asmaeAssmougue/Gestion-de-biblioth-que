...
class AdherentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adherent" do
    assert_difference("Adherent.count") do
      post adherents_url, params: { adherent: { : @adherent., nom: @adherent.nom, prenom: @adherent.prenom } }
    end
  ...
  test "should update adherent" do
    patch adherent_url(@adherent), params: { adherent: { : @adherent., nom: @adherent.nom, prenom: @adherent.prenom } }
