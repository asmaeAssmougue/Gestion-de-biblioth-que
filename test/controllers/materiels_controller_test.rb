...
class MaterielsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materiel" do
    assert_difference("Materiel.count") do
      post materiels_url, params: { materiel: { etat: @materiel.etat, marque: @materiel.marque, nbrStock: @materiel.nbrStock, type: @materiel.type } }
    end
  ...
  test "should update materiel" do
    patch materiel_url(@materiel), params: { materiel: { etat: @materiel.etat, marque: @materiel.marque, nbrStock: @materiel.nbrStock, type: @materiel.type } }
